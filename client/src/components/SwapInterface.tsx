...
export function SwapInterface() {
    ...
    const getQuote = async () => {
        ...
        setLoading(true);
        try {
            const response = await fetch(`https://commandoss-server.duongfinance.com/api/quote/${swapDirection}?amount=${amount}`);
    ...
    const executeSwap = async () => {
        ...
        try {
            // Prepare transaction
            const prepareResponse = await fetch(`https://commandoss-server.duongfinance.com/api/prepare/${swapDirection}`, {
                method: "POST",
